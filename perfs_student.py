...
graph('time',"1x1")
graph('l1d_loadmisses',"1x1")

threads=[1,2,3,4,5,6,7,8]
clunk_sizes=[1,2,4,8,16,32,64,128]
...
def graphfilters(mode):
  ...
  plotter.graph(
    ...
    methods_as_list,  # names for each line
    [colours[method] for method in methods_as_list],
    'graphfilters_{}.png'.format(mode), # filename
    title,
...
default_file="1column.pgm"
graphnewimage('time')
default_file="1row.pgm"
graphnewimage('time')
